...
const RecommendedListingCard = ({ banner, title, location, price }: RecommendedListingCardProps) => {
  ...
  return (
    <Link href={{ pathname: '/properties/[propertyId]', params: { propertyId } }} className='h-[240px] w-[49%]'>
      <View className='h-[240px] w-full bg-pure-light border boder-solid border-royal-blue-fade flex flex-col gap-[12px]'>
